...
namespace ProjetoMVC01
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //configurar para que a classe ProdutoRepository e UsuarioRepository
            //possam receber a string de conexão do banco de dados mapeada no arquivo appsettings.json
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                //configurando a página inicial do projeto: /Account/Login
