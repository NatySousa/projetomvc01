...
namespace ProjetoMVC01.Repositories
{
    public class ProdutoRepository : IProdutoRepository
    {
        ...
        public List<Produto> ConsultarPorDatas(DateTime dataMin, DateTime dataMax)//Para consultar por datas é preciso criar uma procedure no banco
        {
            using (var connection = new SqlConnection(_connectionstring))
            {
                return connection
        ...
        public List<ProdutoGraficoModel> ConsultarTotal()
        {
            ...
            {
                return connection
                    .Query<ProdutoGraficoModel>("SP_CONSULTARTOTALPRODUTOS", commandType: CommandType.StoredProcedure).ToList();
            }
        }
    }
}
